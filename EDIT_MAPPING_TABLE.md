...
- [ ] Implement AST-based renaming (variables, functions, parameters)
- [ ] Implement operator changes
- [ ] Implement literal value changes
- [ ] Implement argument reordering
- [ ] Implement simple statement insertion/deletion

### Phase 2: Placeholder Support (18.3% additional)
- [ ] Create placeholder system for unknown values
- [ ] Implement stub generation for new identifiers
- [ ] Add user prompts for placeholder values
- [ ] Support partial completion workflows

### Phase 3: Hole Syntax (14.1% additional)
- [ ] Define hole syntax: `{}` and `{hint}`
- [ ] Integrate holes with LLM generation
- [ ] Track hole locations and mappings
- [ ] Support hole filling UI

### Phase 4: LLM Integration (21.1% additional)
- [ ] Set up OpenAI API integration
- [ ] Implement prompt templates for each edit type
- [ ] Build LLM result parser
- [ ] Add confidence scoring
- [ ] Handle LLM failures gracefully

### Phase 5: Regeneration Logic (9.9% additional)
...
- [ ] Implement Python → Semiformal summarization
- [ ] Create transient vs semantic classifier
- [ ] Build suggestion UI for propagation
...
This table categorizes **71 semiformal → Python edit types** and **17 Python → semiformal edit types**, covering the full spectrum of bidirectional programming operations.

**Key Insights:**
1. **36.6%** of edits can be handled with direct AST manipulation (no LLM)
2. **18.3%** need placeholder support for unknown values
3. **21.1%** require LLM for semantic understanding
4. Most Python → Semiformal edits are transient and don't need propagation
5. Clear decision trees can automate the strategy selection

This provides a concrete foundation for building the MVP with CodeMirror and OpenAI API.
